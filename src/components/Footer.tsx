      ...
      <div className="container py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-bold">مذاق الجوف</h3>
          ...
          {/* Customer Service */}
          <div className="space-y-4">
            <h3 className="text-xl font-bold">خدمة العملاء</h3>
            <ul className="space-y-2">
              <li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li className="flex items-center space-x-2">
                ...
                <span className="text-white/80">+966 XX XXX XXXX</span>
              </li>
              <li className="flex items-center space-x-2">
                <svg className="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="text-white/80">info@madaqaljouf.com</span>
              </li>
              <li className="flex items-center space-x-2">
                <svg className="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-white/80">منطقة الجوف، المملكة العربية السعودية</span>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className="border-t border-white/10">
        <div className="container py-4">
          <p className="text-center text-white/60">
            جميع الحقوق محفوظة © {new Date().getFullYear()} مذاق الجوف
          </p>
        </div>
      </div>
    </footer>
